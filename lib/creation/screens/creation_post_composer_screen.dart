...
class _CreationPostComposerScreenState extends State<CreationPostComposerScreen> {
    ...
    try {
      _project = _project.copyWith(
        ...
        publishState: <String, dynamic>{
          ..._project.publishState,
          'allowComments': _allowComments,
          'recommend': _recommend,
          'composerSavedAt': DateTime.now().toIso8601String(),
        },
      );
      await CreationProjectStore.instance.save(_project);
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Post settings saved to draft.')),
        );
      }
    } finally {
  ...
  Future<void> _saveSilently() => _save(showFeedback: false);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ...const <String>['Public', 'Followers', 'Only Me'].map(
                (value) => ListTile(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Draft', style: TextStyle(fontWeight: FontWeight.w700)),
          ),
        ],
      ),
      body: ListView(
        ...
        children: [
          ...
          _SectionCard(
            ...
            child: ListTile(
              ...
              title: Text(_project.privacy, style: const TextStyle(fontWeight: FontWeight.w700)),
              subtitle: const Text('Choose who can see this post.'),
            ...
            child: Column(
              children: [
                SwitchListTile.adaptive(
                  ...
                  subtitle: const Text('People can comment on this post.'),
                  onChanged: (value) {
                ...
                SwitchListTile.adaptive(
                  contentPadding: EdgeInsets.zero,
                  value: _recommend,
                  title: const Text('Allow recommendations'),
                  subtitle: Text(
                    _project.privacy == 'Public'
                        ? 'Eligible for OJAS recommendation surfaces.'
                        : 'Only public posts can enter recommendation surfaces.',
                  ),
                  onChanged: _project.privacy == 'Public'
                      ? (value) {
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              ...
              label: Text(_publishing ? 'Publishing…' : 'Publish to OJAS'),
            ),
          ),
          if (!canPublish)
            const Padding(
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Icon(
        ...
        color: value ? const Color(0xFF16A34A) : const Color(0xFF9CA3AF),
      ),
      title: Text(label),
    );
  }
