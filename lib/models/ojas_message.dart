...
class OjasMessage {
  ...
  int reactionCount(String emoji) =>
      reactions.values.where((reaction) => reaction == emoji).length;
  ...
  factory OjasMessage.fromFirestore(
    ...
    return OjasMessage(
      ...
      reactions: _reactionMap(data['reactions']),
      replyToMessageId: _nullableString(data['replyToMessageId']),
      replyToSenderId: _nullableString(data['replyToSenderId']),
      replyToText: _nullableString(data['replyToText']),
      replyToType: _nullableString(data['replyToType']),
      mediaUrl: _nullableString(data['mediaUrl']),
      mediaHash: _nullableString(data['mediaHash']),
      mediaStoragePath: _nullableString(data['mediaStoragePath']),
      mediaWidth: _nullableInt(data['mediaWidth']),
      mediaHeight: _nullableInt(data['mediaHeight']),
    );
  }
  ...
  static Map<String, String> _reactionMap(dynamic value) {
